...
-- Schema project
-- ----------------------------------------------------------------------------
DROP SCHEMA IF EXISTS `bi00gmivizzxtit099hg` ;
CREATE SCHEMA IF NOT EXISTS `bi00gmivizzxtit099hg` ;
USE `bi00gmivizzxtit099hg` ;

-- ----------------------------------------------------------------------------
-- Table project.booking
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`booking` (
...
-- Table project.day1
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day1` (
...
-- Table project.day2
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day2` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table project.day3
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day3` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table project.day4
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day4` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table project.day5
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day5` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table project.day6
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day6` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table project.day7
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`day7` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`schedule` (
  `Day` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`seat_price` (
  `Class` VARCHAR(45) NOT NULL,
  `Price` INT NULL DEFAULT NULL,
  PRIMARY KEY (`Class`));
...
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`trains` (
...
-- Table project.users
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bi00gmivizzxtit099hg`.`users` (
