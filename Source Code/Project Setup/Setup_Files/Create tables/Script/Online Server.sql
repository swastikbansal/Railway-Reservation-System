...
-- Migrated Schemata: bvhnwga1g3mpezf6mrai
-- Source Schemata: bvhnwga1g3mpezf6mrai
...
-- ----------------------------------------------------------------------------
-- Schema bvhnwga1g3mpezf6mrai
-- ----------------------------------------------------------------------------
DROP SCHEMA IF EXISTS `bvhnwga1g3mpezf6mrai` ;
CREATE SCHEMA IF NOT EXISTS `bvhnwga1g3mpezf6mrai` ;
USE `bvhnwga1g3mpezf6mrai` ;

-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.booking
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`booking` (
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day1
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day1` (
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day2
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day2` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day3
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day3` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day4
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day4` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day5
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day5` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day6
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day6` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.day7
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`day7` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.schedule
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`schedule` (
  `Day` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.seat_price
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`seat_price` (
  `Class` VARCHAR(45) NOT NULL,
  `Price` INT NULL DEFAULT NULL,
  PRIMARY KEY (`Class`));
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.trains
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`trains` (
...
-- ----------------------------------------------------------------------------
-- Table bvhnwga1g3mpezf6mrai.users
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `bvhnwga1g3mpezf6mrai`.`users` (
...
INSERT INTO `users` VALUES (1,'G_coder','Admin','Gatij','Shakyawar','9893620986','gatij.shakya.29.11@gmail.com','gatij@2911','11/29/03',50000),(2,'Swastik117','Admin','Swastik','Bansal','7024069004','swastikbansal0@gmail.com','abcd1234','11/06/04',50000),(3,'a','','a','a','5086604150','a','a','00/00/00',26125),(4,'b',NULL,'b','b','1234567890','b','b','1/4/00',50000);
